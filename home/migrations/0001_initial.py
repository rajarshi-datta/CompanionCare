    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('resident', 'Resident'), ('caregiver', 'Caregiver')], default='resident', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meal', models.CharField(blank=True, max_length=50, null=True)),
                ('assistance', models.CharField(blank=True, max_length=100, null=True)),
                ('visit_schedule', models.CharField(blank=True, max_length=100, null=True)),
